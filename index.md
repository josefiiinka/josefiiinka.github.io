...
<button class="tile write" data-dialog="writing" aria-haspopup="dialog"><span class="tile-name">Píšu <span aria-hidden="true">✏️</span></span><span class="tile-note">Články a deník</span><span class="tile-arrow" aria-hidden="true">+</span></button>
